...
var p1_epsilon = board.create('point', [0, 1], {
	name: '',
	fixed: true,
	color: "#ffffff",
	size: 3,
});
var p2_epsilon = board.create('point', [0, 1], {
	name: '',
	fixed: true,
	color: "#ffffff",
	size: 3,
...
var p3_epsilon = board.create('point', [30, 1], {
	name: '',
	fixed: true,
	color: "#ffffff"
});
var p4_epsilon = board.create('point', [30, 1], {
	name: '',
	fixed: true,
	color: "#ffffff"
});
