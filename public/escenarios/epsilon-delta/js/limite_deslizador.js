...
function changeDelta() {
    ...
    inputDelta = parseFloat(getInputDelta.value) / 100;
...
function changeDelta() {
    ...
    const nuevoDelta = parseFloat(document.getElementById('inputDelta').value) / 100;
...
function reload() {
    ...
    minX = p - inputDelta; // minimum x-coordinate value
    maxX = p + inputDelta; // maximum x-coordinate value
